import forbidden from '../../assets/errors/403-img.png'

function Forbidden() {

    const bgImage = {'backgroundImage':`url(${forbidden})`, 'backgroundSize':'400px',  'backgroundPosition':'50% 30%'}

  return (
    <div className="relative h-[400px] bg-no-repeat    rounded  sm:w-screen sm:h-screen border  border-black " style={bgImage} >
      <h1 className='w-fit mx-auto text-2xl font-bold mt-5'>FORBIDDEN</h1>
